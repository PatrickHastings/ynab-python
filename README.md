...
```sh
pip install git+https://github.com/PatrickHastings/ynab-python.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/PatrickHastings/ynab-python.git`)
